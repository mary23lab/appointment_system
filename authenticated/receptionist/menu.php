		...
		<div class="sidebar">
			...
			<nav class="mt-2" style="font-size: 15px !important">
				<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
					...
					<li class="nav-item">
						<a href="pet-records.php" class="d-flex align-content-center nav-link <?= strpos($_SERVER['REQUEST_URI'], 'pet-records.php') !== false || strpos($_SERVER['REQUEST_URI'], 'pet-details.php') !== false ? 'active' : '' ?>">
