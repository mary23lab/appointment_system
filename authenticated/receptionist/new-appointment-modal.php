                ...
                <form method="POST" onsubmit="showLoaderAnimation()" action="pet-details.php?id=<?= $pet_id; ?>&method=new_appointment_pet">
                    <div class="row">
                        <div class="col-xl-12 mb-2">
                            <label class="small">Visit Type <span class="text-danger">*</span></label>

                            <select required id="visit_type" name="visit_type" class="select form-control form-control-sm">
                        ...
                        <div class="col-xl-12 mb-2">
                            ...
                            <div class="input-group">
                                <input type="datetime-local" class="form-control form-control-sm" required name="appointment_datetime">
